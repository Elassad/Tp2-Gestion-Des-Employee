...
namespace TP2.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            Employe employee = employeeRepository.GetEmployee(id);
        ...
        public ActionResult Edit(EditViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Employe employee = employeeRepository.GetEmployee(model.Id);
                ...
                Employe updatedEmployee = employeeRepository.Update(employee);
